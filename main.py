# Var2 (a messenger): add different types of messages (e.g. text, image, ...)
class User:
...
if __name__ == '__main__':
    ...
    wapp.add_message(Text('Yes', 'chat_MIPT_SD', user1))
    wapp.add_message(Text('Yes', 'chat_MIPT_SD', user1))
    wapp.add_message(Text('No', 'chat_MIPT_MO', user2))
    wapp.add_message(Text('Yes', 'chat_MIPT_SD', user2))
